...
try {
    ...
    error_log('Student view evaluation fetch error: ' . $e->getMessage());
    $ev = false;
}
    ...
    <body style="background:#f4f6f9;">
        <div style="max-width:900px;margin:40px auto;padding:20px;">
            <div class="card">
                ...
                <p>The requested evaluation could not be located.</p>
...
$resultColor = ($score <= 50) ? '#b91c1c' : '#166534';
?><!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <style>
        ...
        .download-link { display:inline-block; color:#fff; background:#0f766e; padding:9px 12px; border-radius:8px; text-decoration:none; font-weight:700; }
        .download-link:hover { background:#115e59; }
...
<div class="page">
    <div class="top-actions">
        ...
        <a href="download_evaluation_pdf.php?id=<?php echo (int) $ev['id']; ?>" class="download-link">Download PDF</a>
    </div>

    <div class="card card-inner">
        <h2 style="margin-top:0;margin-bottom:16px;">My Evaluation Details</h2>
        ...
        <div class="details">
            ...
            <div class="value" style="font-weight:800;color:<?php echo htmlspecialchars($resultColor); ?>;"><?php echo htmlspecialchars($result); ?></div>
